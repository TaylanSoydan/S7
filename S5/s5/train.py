...
def train(args):
    ...
    if args.stablessm_a:
        print("stable ss at train.py 99")
        a = 1
        b = 0.5
        Lambda = np.sqrt(( -1/Lambda - b ) / a)
    ...
    if args.mix:
        print("train.py mix true")
        s5_init_fn = init_S5SSM(H=args.d_model,
                            P=ssm_size,
                            Lambda_re_init=Lambda.real,
                            Lambda_im_init=Lambda.imag,
                            V=V,
                            ...
                            stablessm_a=False)
        s7_init_fn = init_S5SSM(H=args.d_model,
                            P=ssm_size,
                            Lambda_re_init=Lambda.real,
                            Lambda_im_init=Lambda.imag,
                            V=V,
