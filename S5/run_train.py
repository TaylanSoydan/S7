...
if __name__ == "__main__":
	...
	parser.add_argument("--wandb_entity", type=str, default="taylansoydan",
						help="wandb entity name, e.g. username")
	parser.add_argument("--dir_name", type=str, default="/data/storage/tsoydan/data/long-range-arena/lra_release/lra_release",#'./cache_dir',
	...
	parser.add_argument("--input_dependent", type=str2bool, default=False,
						help="s7")
	parser.add_argument("--stablessm_a", type=str2bool, default=False,
						help="stablessm")
